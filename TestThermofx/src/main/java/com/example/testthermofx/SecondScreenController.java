...
public class SecondScreenController {
    ...
    public void initialize() {
        ...
        displaySettings(Path.of("test.json"));
        ...
        saveButton.setOnAction(event -> {
            ...
            DataTools.writeFileData(Path.of("test.json"), setting);
        ...
        returnButton.setOnAction(actionEvent -> {
            try {
                ...
                // the return button.
                TestThermoApp.setRoot("StartScreen");
            }
        ...
        deleteButton.setOnAction(actionEvent -> {
            ...
            DataTools.updateFile(Path.of("test.json"), settings);
        });
    }
